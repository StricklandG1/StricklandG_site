...
public class Top20Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView movieList = (ListView) findViewById(R.id.top20_listview);
        ...
        movieList.setOnItemClickListener(new AdapterView.OnItemClickListener()
            {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id)
                {
                    ...
                    Intent goToIntent = new Intent(Top20Activity.this, SingleMovie.class);
        ...
        //String url = "https://13.59.50.236:8443/CS_122B_Fablix_Project_API_Version/api/top_20";
        String url = "http://10.0.2.2:8080/CS_122B_Fablix_Project_API_Version/api/top_20";
        final StringRequest getData = new StringRequest(
            ...
            new Response.Listener<String>()
            {
                ...
                public void onResponse(String response)
                {
                    ...
                    {
                        Log.e("JsonArray: ", "Could not parse data");
                    }
                }
            },
    ...
    {
        Intent goToIntent = new Intent(Top20Activity.this, SearchActivity.class);
        String query = ((EditText) findViewById(R.id.search_txt)).getText().toString();
